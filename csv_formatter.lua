...
function main()
    ...
    csv_file = io.open(FOLDER_NAME .. arg[1] .. "/" .. arg[2] .. ".csv","r")
    if csv_file == nil then
        return
    end
...
--\205\206\207\208\209\210\211\212\213\214\215\216\216\217\218\219\220\221\222\223 \
--\nback to russian again?\
